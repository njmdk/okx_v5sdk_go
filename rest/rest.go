...
type RESTAPI struct {
	...
	isSimulate bool
	Debug      bool //false:不输出信息 true:输出信息
}
...
type RESTAPIResult struct {
	...
	// okexV5返回的数据
	V5Response    OkxV5APIResponse `json:"v5Response"`
...
isSimulate: 是否为模拟环境
*/
func NewRESTClient(endPoint string, apiKey *APIKeyInfo, isSimulate bool, debug bool) *RESTAPI {
...
func NewRESTAPI(ep, method, uri string, param *map[string]interface{}, debug bool) *RESTAPI {
	//TODO:参数校验
...
func (this *RESTAPI) SetDebug(b bool) *RESTAPI {
	this.Debug = b
	return this
}
...
// POST请求
func (this *RESTAPI) Post(ctx context.Context, uri string, param interface{}) (res *RESTAPIResult, err error) {
	this.Method = POST
	this.Uri = uri
...
func (this *RESTAPI) Run(ctx context.Context) (res *RESTAPIResult, err error) {
	...
	// 解析结果
	var v5rsp OkxV5APIResponse
	err = json.Unmarshal(resBuff, &v5rsp)
	if err != nil {
		fmt.Println("解析v5返回失败！", string(resBuff), err)
		return
	}
...
func (this *RESTAPI) GenReqInfo() (uri string, body string, err error) {
	...
	case GET:
		...
		Param := this.Param.(map[string]interface{})
